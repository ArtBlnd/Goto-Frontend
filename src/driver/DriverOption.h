...
public:
    ...
    DriverOption(DriverOptionTable* Table, std::string Key, std::any Init, DriverOptionLevel Level); // With no
                                                                                                     // descprition
...
#define DEF_DRV_OPTION(Table, Name, Key, Init, Desc, Level) \
    DriverOption Name = DriverOption(Table, Key, Init, Desc, Level);
